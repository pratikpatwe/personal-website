...
export default function Hero() {
  return (
    <div className="relative text-center z-10 flex flex-col items-center px-4 w-full max-w-4xl mx-auto pt-8 md:pt-12 overflow-hidden">
      ...
      >
        ...
        ></div>
        <Image
          src="https://avatars.githubusercontent.com/u/186058261?v=4"
          alt="Pratik Patwe"
          width={200}
          height={200}
          priority
